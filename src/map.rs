...
pub fn initiate_map(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    let (wall_tilemap_entity, wall_tile_storage) = create_map(
        ...
        &mut commands,
        MapKind::SolidMap(
            Map::from_string("11111111111111111111111111111111
...
11111111111111111111111111111111
"),
            Map::from_string("Path::new11111111111111111111111111111111
11111111111111111111111111111111
11111111111111111111111111111111
11111111111111111111111111111111
11111111111111111111111111111111
...
"),
    ...
    let (floor_tilemap_entity, floor_tile_storage) = create_map(
        map_size,
        &mut commands,
        MapKind::AssetIndexMap(Map::from_string("00000000000000000000000000000000
